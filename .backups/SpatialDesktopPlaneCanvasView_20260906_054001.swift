...
public struct SpatialDesktopPlaneCanvasView: View {
    ...
    public var body: some View {
        ZStack {
            // ── 1. Cosmic Liquid Glass Backdrop ──
            ...
            VStack(spacing: 14) {
                // Header Bar with Formation & Add Desktop
                spatialHeaderBar

                Spacer(minLength: 2)

                // Continuous Canvas Body (3x3 Plane or Stacked Vertical Ribbon)
                ZStack {
