...
public final class SpatialPlaneManager: ObservableObject {
    ...
    @AppStorage("nexus.continuousCanvasFormation") public var continuousCanvasFormation: String = "3x3 Spatial Plane"
    ...
    public func zoomOutToPlane() {
        ...
        refreshAllRAMBuffers()
        focusedPlaneIndex = max(1, min(9, MacDesktopsManager.shared.currentSpaceIndex))
